...
📖 **[The Holler Guide](../../wiki)** — quick start, a tour of the codebase, and first-principles explanations (with proofs and diagrams) of every algorithm used: UDP hole punching, SPAKE2, AES-GCM, gossip routing, Lamport clocks, and more. Published to the project wiki from [`docs/wiki/`](docs/wiki) on every push to `main`.
